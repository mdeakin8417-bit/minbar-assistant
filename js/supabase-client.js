...
async function isPushSubscribed() {
  ...
  try {
    ...
    // পারমিশন আগেই দেওয়া আছে কিন্তু সাবস্ক্রিপশন হারিয়ে গেছে (ব্রাউজার/ক্যাশ রিসেট ইত্যাদির কারণে)
    // — নিরবে আবার সাবস্ক্রাইব করে নেওয়া, নতুন করে পারমিশন চাইবে না যেহেতু আগেই অনুমতি আছে
