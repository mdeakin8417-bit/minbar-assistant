...
const translations = {
  bn: {
    ...
    privacyTagline: "আপনার তথ্যের নিরাপত্তা আমাদের অগ্রাধিকার", termsTagline: "অ্যাপ ব্যবহারের নিয়মাবলী", aiTagline: "আপনার ব্যক্তিগত ইসলামিক সহকারী", videoStorageRow: "ভিডিও স্টোরেজ প্যাকেজ",
  ...
  en: {
    ...
    privacyTagline: "Your data security is our priority", termsTagline: "App usage guidelines", aiTagline: "Your personal Islamic assistant", videoStorageRow: "Video Storage Package",
